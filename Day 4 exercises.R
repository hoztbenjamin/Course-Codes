...
# Q1 What preliminary conclusions can home owners draw from the data?
...
# There is a direct correlation between having more selling more drinks and having more number of stores 
